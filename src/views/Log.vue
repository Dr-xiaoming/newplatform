<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload action="http://localhost:9090/log/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <!--      <el-table-column prop="output" label="出参" :show-overflow-tooltip="true"></el-table-column>-->
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="40%" :close-on-click-modal="false">
      <el-form label-width="140px" size="small" style="width: 85%;" :model="form" :rules="rules" ref="ruleForm">
        ...
        <el-form-item prop="deleted" label="软删除">
          <el-input v-model="form.deleted" autocomplete="off"></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    save() {
      this.$refs['ruleForm'].validate((valid) => {
        if (valid) {
          this.request.post("/log", this.form).then(res => {
            if (res.code === '200') {
    ...
    exp() {
      window.open("http://localhost:9090/log/export")
    },
