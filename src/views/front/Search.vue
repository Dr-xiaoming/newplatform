  ...
  <div style="width:800px;margin: 15px auto">
    <div style="margin: 20px 0 0 0">
      <div style="text-align: center">
        <el-input size="small" style="width: 700px" placeholder="请输入新闻名称/新闻类别" v-model="name" suffix-icon="el-icon-search"></el-input>&nbsp;
    ...
    <div
      ...
      <span style="text-align: center">搜索{{name}}</span>
    </div>
    <div>
